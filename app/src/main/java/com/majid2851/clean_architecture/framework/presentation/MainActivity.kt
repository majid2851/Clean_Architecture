...
import com.majid2851.clean_architecture.framework.presentation.common.displayToast
import com.majid2851.clean_architecture.framework.presentation.common.gone
    ...
    UIController
{
    ...
    {
        val main_progress_bar=findViewById<ProgressBar>(R.id.main_progress_bar)
        if(isDisplayed)
