...
fun fakeData():List<Note>{
    ...
    notes.add(
        Note("2474abea-7584-486b-9f88-87a21870b0ec",
        "Vancouver PNE 2019",
    ...
    notes.add(
        Note("2474fbaa-7884-4h6b-9b8z-87a21670b0ec",
        "Ready for a Walk",
    ...
    notes.add(
        Note("2474mbaa-7884-4htb-9baz-87a216a0b0ec",
        "Maizy Sleeping",
    ...
    notes.add(
        Note( "2474fpaa-k884-4u6b-9biz-87am1670b0ec",
        "My Brother Blake",
    ...
    notes.add(
        Note("2474abaa-788a-4a6b-948z-87a2167hb0ec",
        "Lounging Dogs",
    ...
    notes.add(
        Note( "24742baa-78j4-4z6b-9b8l-87a11670b0ec",
    ...
    notes.add(
        Note("2g74fbaa-78h4-4hab-9b85-87l21670b0ec",
    ...
    notes.add(
        Note( "2477fbaa-7b84-4hjb-9bkl-87a2a670b0ec",
        "Aldergrove Park",
    ...
    notes.add(
        Note( "2477fbbb-7b84-g5jb-9bkl-8741a670b0ec",
        "My Computer",
    ...
    notes.add(
        Note("247aaabb-7564-g5jb-9bkl-8741ah70b0ec",
        "Courses",
